...
public class Leaderboard extends Route {

	public Map<String, Object> m = new HashMap<String, Object>();

	public String mode = "osu";

	public Leaderboard(String path, String mode) {
		super(path);
		this.mode = mode;
	}
	...
	public Object handle(Request request, Response response) {
		...
		JSONObject jsonObject = new JSONObject(API.request("leaderboard?p=" + page + "&mode=" + mode));
		...
		m.put("which", "Performance");
		m.put("url", "performance");
